...
import { createLogStory, getLogStory } from "@/lib/supabase/server-extended/log-stories";
...
export default function Home() {
    ...
    if (!profile || !story) return <div className="w-full h-full flex items-center justify-center">
