            ...
            <div className="flex flex-col">
              ...
              <div className="grid grid-cols-1 gap-6">
                <Card
                  ...
                  onClick={() => {
                    setFormData((fd) => ({ ...fd, event_type: "single_day" }));
                    setStep(4);
                  }}
                >
                  <CardContent className="flex items-start space-x-4 p-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Perfect for birthdays, anniversaries, or one-time
                        celebrations
                      </p>
                ...
                <Card
                  ...
                  onClick={() => {
                    setFormData((fd) => ({ ...fd, event_type: "multi_day" }));
                    setStep(4);
                  }}
                >
                  <CardContent className="flex items-start space-x-4 p-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Ideal for festivals, multi-day celebrations, or extended
                        events
                      </p>
                      <div className="inline-flex items-center text-green-600 font-medium">
                        Select
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-3 gap-4">
                    <Input
                      ...
                      placeholder="DD"
                      value={
                        formData.start_date ? formData.start_date.getDate() : 0
                      }
                      onChange={(e) =>
                        setFormData((fd) => ({
                          ...fd,
                          start_date: new Date(
                            fd.start_date?.setDate(parseInt(e.target.value)) ||
                              new Date()
                          ),
                          end_date: new Date(
                            fd.start_date?.setDate(parseInt(e.target.value)) ||
                    ...
                    <Select
                      value={
                        formData.start_date
                          ? formData.start_date.getMonth()?.toString()
                          : "undefined"
                      }
                      onValueChange={(e) => {
                        ...
                        setFormData((fd) => ({
                          ...fd,
                          start_date: new Date(
                            fd.start_date?.setMonth(parseInt(e)) || new Date()
                          ),
                          end_date: new Date(
                            fd.start_date?.setMonth(parseInt(e)) || new Date()
                          ),
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <Input
                      ...
                      placeholder="DD"
                      value={
                        formData.end_date ? formData.end_date.getDate() : 0
                      }
                      onChange={(e) =>
                        setFormData((fd) => ({
                          ...fd,
                    ...
                    <Select
                      value={
                        formData.end_date
                          ? formData.end_date.getMonth().toString()
                          : "undefined"
                      }
                      onValueChange={(e) => {
                        if (e === "undefined") return;
                    ...
                    <Input
                      ...
                      placeholder="YYYY"
                      value={
                        formData.end_date ? formData.end_date.getFullYear() : 0
                      }
                      onChange={(e) =>
                        setFormData((fd) => ({
                          ...fd,
                ...
                <DialogContent>
                  ...
                  <div className="py-4">
                    ...
                    <p className="text-lg font-semibold">
                      {formData.start_date?.toDateString()}
                    </p>
                    {formData.event_type === "multi_day" ? (
                      <>
                        <p className="text-gray-600 mt-2 mb-1">to</p>
                        <p className="text-lg font-semibold">
                          {formData.end_date?.toDateString()}
                        </p>
                      </>
                    ) : (
                      <></>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData((fd) => ({
                            ...fd,
                            start_time: removeDate(
                              new Date(`0 ${e.target.value}`)
                            ),
                          }))
                        }
                      />
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  ...
                  <label
                    ...
                    className={`cursor-pointer ${
                      imageFiles.length >= 5 ? "opacity-50" : ""
                    }`}
                  >
